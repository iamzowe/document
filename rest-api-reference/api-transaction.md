...
```shell
curl -X POST 'https://api.cpay.ltd/openapi/v1/withdraw' \
...
```shell
curl -X POST 'https://api.cpay.ltd/openapi/v1/createCryptoOrder' \
-H 'Content-Type: application/x-www-form-urlencoded' \
...
```json
{
  ...
  "data": {
    ...
    "cashierURL": "https://cashier.cpay.ltd/payment?orderId=2302280607488abc123&sign=875ee0c50a97d06f1bxxx",
    "returnURL": "",
    "successURL": "",
    "failURL": "",
    "remark": ""
...
```shell
curl -X POST 'https://api.cpay.ltd/openapi/v1/createCreditCardOrder' \
-H 'Content-Type: application/x-www-form-urlencoded' \
...
```json
{
  ...
  "data": {
    ...
    "pledgeAmount": "0",
    "fee": "0",
    "cashierURL": "https://cashier.cpay.ltd/payment?orderId=2302280abc123&sign=a20e7b594edxxxx",
